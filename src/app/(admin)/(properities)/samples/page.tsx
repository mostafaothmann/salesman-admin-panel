...
export default function SamplesPage() {
    const { dataSamples, sampleD, filter_total, total, getFilteredDataSamples, getSamplesData, getSampleData, filteredDataSamples } = useMedicalStore();
    ...
    return <div>
        ...
        <div className="max-w-full">
            {filtered ? <Table
                ...
                dataSource={filteredDataSamples || []} />
                :
                <Table
                    scroll={{ x: "max-content" }}
                    style={{ maxWidth: 1100 }}
