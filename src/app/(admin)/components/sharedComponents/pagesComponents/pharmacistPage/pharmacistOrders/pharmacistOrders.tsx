...
import { apiAssistant, apiOffer, apiPharmacist, apiProduct, apiSalesman, apiType } from "../../../../../../../stores/apis";

export default function PharmacistOrders({ profile_id }: profileComponent) {
    const { getOrdersData, deleteProduct, editProduct, deleteOffer,
    ...
    const fetchDataOrders = async () => {
        try {
            const res = await apiPharmacist.get(`/orders/${profile_id}`);
            setOrders(res.data);
        } catch (error) {
