...
import { apiAssistant, apiDoctor, apiPharmacist, apiType, apiSalesman, apiSample, apiBaseGift, apiGiftVisit, apiArea } from "../../../../../../../stores/apis";
...
export default function AreaPharmacistsVisits({ profile_id }: profileComponent) {
    ...
    const { getDoctorVisitData, pharmacistVisitD, editDoctorVisit } = useMedicalStore();

    const [pageLoading, setPageLoading] = useState(true);
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await apiArea.get(`/pharmacists-visits/${profile_id}`);
                setVisits(res.data);
                const [
                    salesmanRes,
                    pharmacistRes,
