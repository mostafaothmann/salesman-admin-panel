...
import { apiArea, apiDoctor, apiHospital } from "../../../../../../../stores/apis";


export default function AreaHospitals({ profile_id }: profileComponent) {
    ...
    const fetchDataHospitals = async () => {
        try {
            const res = await apiArea.get(`/hospitals/${profile_id}`);
