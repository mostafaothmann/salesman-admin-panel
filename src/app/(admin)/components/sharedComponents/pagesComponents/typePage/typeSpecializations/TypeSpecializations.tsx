...
export function TypeSpecializations({ profile_id }: profileComponent) {
    ...
    useEffect(() => { getSpecializationForType(profile_id) }, [])

    //Add Modal
    const [type_id, setTypeId] = useState(profile_id);
    ...
    async function handleAdd() {
        ...
        getSpecializationForType(profile_id);
        setSearchText("");
    ...
    async function handleDelete() {
        ...
        const deleted = dataSpecializationTypes?.find(e => e.specialization_id == found && e.type_id == profile_id)?.id;
    ...
    const optionsForDelete = dataSpecializationForType?.map(e => { return { value: e.profile_id, label: e.name } })
