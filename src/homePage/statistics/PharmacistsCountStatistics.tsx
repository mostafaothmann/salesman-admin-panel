...
export default function PharmacistsCountStatistics() {
  const { dataPharmacists, getPharmacistsData } = useMedicalStore();
  //useEffect(() => { getPharmacistsData() }, [])
  return (
